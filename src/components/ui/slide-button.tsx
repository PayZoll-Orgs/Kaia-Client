  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        className="relative flex h-9 items-center justify-center rounded-full bg-gray-100 shadow-lg"
      >
        {!completed && (
          <motion.div
            style={{
            ...
            className="absolute inset-y-0 left-0 z-0 rounded-full bg-green-500"
          />
        )}
          ...
          {!completed && (
            ...
            >
              <Button
                ...
                size="icon"
                className={cn(
                  "rounded-full drop-shadow-xl bg-green-600 hover:bg-green-700 text-white",
          ...
          {completed && (
            ...
            >
              <Button
                ...
                {...props}
                className={cn(
                  "size-full rounded-full transition-all duration-300 bg-green-600 hover:bg-green-700 text-white",
                  className
                )}
              >
